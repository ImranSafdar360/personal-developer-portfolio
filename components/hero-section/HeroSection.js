...
const HeroSection = () => {
  return (
    <div className="w-full h-[40vh] md:h-[85vh] lg:h-[100vh] flex flex-col justify-center items-center px-4 md:px-8 gap-4 md:gap-6 lg:gap-8">
      {/* Title */}
      ...
      {/* Subtitle */}
      <p className="w-full md:max-w-[500px] lg:max-w-[600px] xl:max-w-[800px] font-lato font-medium text-center text-[14px] leading-[20px] md:text-[16px] md:leading-[22px] lg:text-[18px] lg:leading-[24px] xl:text-[22px] xl:leading-[28px] text-secondary-text">
