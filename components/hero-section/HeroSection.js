  ...
  return (
    <div className='w-full h-[100vh] flex flex-col justify-center items-center gap-[30px]'>
      <h1 className='font-anton text-[72px] leading-[82px] text-center'>Crafting digital experiences <br /> that inspire and engage.</h1>
        <p className='font-lato font-medium text-center text-[22px] text-secondary-text'>Transform Your Website into a Modern Masterpiece with Stunning Animations, <br /> Seamless Functionality, and Pixel-Perfect Precision.</p>
