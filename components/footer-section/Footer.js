...
const Footer = () => {
  return (
      <div className='w-full h-full bg-whole text-whole-text px-[60px]'>
      ...
      <h1 className='text-[18.3vw] font-antonSc leading-[17vw] translate-y-14
        ...
        <div className='w-full px-10 py-8 flex justify-between items-center bg-whole text-whole-text z-10 border-t border-white-border'>
          <p>© 2024 Imran Devify
