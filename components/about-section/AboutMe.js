...
const AboutMe = () => {
  return (
    <div className='w-full h-full flex justify-between gap-[40px]'>
      ...
      <p className='text-[24px] font-anton text-yellow-400'>Who I Am.</p>
      ...
      <div className='w-full max-w-[50%] flex flex-col justify-end items-start gap-[40px] mt-[450px]'>
        <p className='text-[22px] font-roboto font-medium leading-[29px] text-whole-text'>I Collaborate with Global Clients to Create Compelling and Immersive Digital Experiences Through Innovative Web Design and Development.</p>
