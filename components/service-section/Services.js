...
//         <div key={index} className='w-full h-[230px] lg:w-[560px] lg:h-[290px] flex justify-center items-center rounded-[40px] bg-[#1C1C20] px-[36px]'>
  ...
  return (
    <div className="w-full flex flex-col items-end gap-[40px]">
      {servicesData.map((service) => (
        <SpotlightCard key={service.id} className="custom-spotlight-card cursor-pointer border-none !p-0 !m-0">
          <div className='w-full h-[450px] lg:h-[300px] xl:w-[560px] xl:h-[290px] flex justify-center items-center rounded-[40px] bg-[#1C1C20] px-[25px] md:px-[36px] py-[40px]'>
            <div className='flex gap-[20px] justify-center items-start'>
              <h3 className='text-[28px] font-anton leading-[42px] text-whole-text'>{service.id}</h3>
              <div className='flex flex-col gap-[20px]'>
                <h2 className='text-[36px] font-anton leading-[42px] text-whole-text'>{service.title}</h2>
