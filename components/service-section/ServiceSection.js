  ...
  return (
    <div className='w-full h-full flex flex-col xl:flex-row justify-between items-start gap-[60px] lg:gap-[100px] relative'>
      ...
      <h1 className="text-[36px] md:text-[48px] lg:text-[64px] xl:text-[72px] leading-none font-antonSc text-whole-text mb-2">I help your business grow</h1>
        <p className="w-full lg:w-[520px] text-[16px] md:text-[18px] lg:text-[20px] xl:text-[22px] font-lato font-medium leading-relaxed text-secondary-text">As a distinguished Web Developer, I offer comprehensive solutions encompassing research, wireframing, UI design, and development. Here are our specialized services:</p>
      </div>
